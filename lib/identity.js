...
//   1. Environment — DARKNODE_OPERATOR / DARKNODE_TEAM. This is the SSO / IdP hook:
...
function resolveOperator(opts) {
  ...
  let operator = (env.DARKNODE_OPERATOR || env.DARKNODE_USER || "").trim();
  let team = (env.DARKNODE_TEAM || "").trim();
