...
(function (root, factory) {
  ...
  function detectFileType(input) {
    ...
    // Heuristic: all-printable/whitespace short buffer looks like text.
    const printable = [...b.subarray(0, 512)].every((c) => (c >= 0x20 && c <= 0x7e) || c === 9 || c === 10 || c === 13);
    if (b.length && printable) return { ext: "txt", mime: "text/plain", desc: "Plain text", matched: false };
